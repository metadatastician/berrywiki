...
# ============================================================================
# GENERATED by launch-scaffolder from berrywiki.launcher.a2ml.
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/berrywiki/berrywiki.launcher.a2ml"
...
START_COMMAND=""
for candidate in \
    "/target/release/berrywiki-cli" \
    "/crates/berrywiki-cli/target/release/berrywiki-cli" \
    "berrywiki-cli" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in berrywiki.launcher.a2ml."
            return 1
        fi
    fi
